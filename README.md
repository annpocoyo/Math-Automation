...
You will need to download the latest version of [`chromedriver`](https://googlechromelabs.github.io/chrome-for-testing/#stable) from Google and place it in the same directory as the downloaded binary from above (alternatively it can be placed in the PATH).

If there is no binary for your platform you may still run this script by using manually installing the PIP package and running it.

## Dependencies

If you aren't using the supplied binaries/packages and aren't using a build system, you will need Python and the following programs/modules:
