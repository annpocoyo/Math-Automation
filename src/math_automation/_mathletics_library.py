...
from math_automation._auto_browser_base import AutoBrowserBase # Base for automatic browser control
...
class AutoMathleticsClass(AutoBrowserBase):
    ...
    def __init__(self, chrome_driver_path = None):
        ...
        super().__init__(url = "https://studentportal.mathletics.com/", chrome_driver_path=chrome_driver_path)
